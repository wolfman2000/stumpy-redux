enum NodeId {
  ...
  // Dark D1 entrances
  DARK_TREASURE_GAME_ENTRANCE = 1228,
  ...
  // Light D1 caves
  CAVE_WELL_TOP = 4055,
  CAVE_WELL_HIDDEN = 4056,
  CAVE_WELL_BOTTOM = 4057,
  CAVE_BLINDS_HIDEOUT_TOP = 4058,
  CAVE_BLINDS_HIDEOUT_BOTTOM = 4059,
  CAVE_BLINDS_HIDEOUT_HIDDEN = 4060,
  CAVE_WOMAN_HOME_LEFT = 4061,
  CAVE_WOMAN_HOME_RIGHT = 4062,
  CAVE_SNITCH_LEFT_HOME = 4063,
  CAVE_SNITCH_RIGHT_HOME = 4064,
  CAVE_CUCCO_HOUSE = 4065,
  CAVE_CUCCO_ITEM = 4066,
  CAVE_SICK_KID_HOME = 4067,
  CAVE_SICK_KID_ITEM = 4068,
  CAVE_TAVERN_BACK = 4069,
  CAVE_GRASS_HOME = 4070,
  CAVE_BOMBABLE_HUT = 4071,
  CAVE_KAKARIKO_SHOP = 4072,
  CAVE_TAVERN_FRONT = 4073,

  // Light D4 caves (excluding Hyrule Castle & Castle Tower)
  CAVE_UNCLE_ENTRANCE = 4074,
  CAVE_UNCLE_EXIT = 4075,

  // Light D7 caves (excluding Eastern Palace)
  CAVE_SAHAS_MAIN = 4076,
  CAVE_SAHAS_CLOSET = 4077,

  // Light E3 caves
  CAVE_BLACKSMITHS = 4078,
  CAVE_MAD_BATTER_ENTRANCE = 4079,
  CAVE_MAD_BATTER_ITEM = 4080,
  CAVE_MAD_BATTER_EXIT = 4081,

  // Light F1 caves
  CAVE_FIGHTING_BROS_LEFT = 4082,

  // Light F2 caves
  CAVE_FIGHTING_BROS_RIGHT = 4083,
  CAVE_LIBRARY_MAIN = 4084,
  CAVE_LIBRARY_ITEM = 4085,
  CAVE_KAKARIKO_CHEST_GAME = 4086,

  // Light F4 caves
  CAVE_HOUSE_BONK_ROCKS = 4087,
  ...
  // Dark G8 caves
  CAVE_DARK_ICE_CAVE = 4548,
  CAVE_DARK_BEE_CAVE = 4549,
  CAVE_DARK_ROCK_CAVE = 4550,
